...
try{
    ...
    console.log("파일명 :/node01_start.js를 동기식으로 읽기====");
    console.log(data);
}catch(error){
    console.log("동기식 파일읽기 예외 발생..."+ error);
}
